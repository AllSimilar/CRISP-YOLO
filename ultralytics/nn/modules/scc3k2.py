...
from .block import C3, C2f, PSABlock
...
class ScBottleneck(nn.Module):
    def __init__(self, c1, c2, shortcut=True, g=1, k=(3, 3), e=1.0):
        ...
        c_ = int(c2 * e)
        assert c1 == c_ == c2, (
            f"ScBottleneck 要求 c1==c_==c2（因为 ScConv 通道不变），got c1={c1}, c_={c_}, c2={c2}, e={e}"
        )
...
class SCC3k(C3):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5, k=3):
        ...
        c_ = int(c2 * e)
        self.m = nn.Sequential(*(ScBottleneck(c_, c_, shortcut, g, k=(k, k), e=1.0) for _ in range(n)))
